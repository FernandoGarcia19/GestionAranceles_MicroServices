...
public class PersonInChargeRepository: IRepository
{
    ...
    public async Task<int> Insert(PersonInCharge.Dom.Model.PersonInCharge t)
    {
...
VALUES (@first_name, @last_name, @email, @phone, @ci, @created_by, @created_date, @last_update, @status);";
    ...
    public async Task<int> Update(PersonInCharge.Dom.Model.PersonInCharge t)
    {
        using var conn = _connectionDB.GetConnection();
        await conn.OpenAsync();
...
WHERE id = @id;";
    ...
    public async Task<int> Delete(PersonInCharge.Dom.Model.PersonInCharge t)
    {
        using var conn = _connectionDB.GetConnection();
        await conn.OpenAsync();
    ...
    public async Task<List<PersonInCharge.Dom.Model.PersonInCharge>> Select()
    {
    ...
    public async Task<PersonInCharge.Dom.Model.PersonInCharge> SelectById(int id)
    {
        using var conn = _connectionDB.GetConnection();
        await conn.OpenAsync();
